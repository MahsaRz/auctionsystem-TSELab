                    ...
                    <div class="col-md-4" id="<?php echo $item->auctionID ?>Card">
                        <div class="card mb-4 shadow-sm">
                            <div class="text-center">
                                <img style="height: 250px; width: auto;" class="mx-auto m-3 rounded img-thumbnail" src="<?php echo URLROOT; ?>/img/<?php echo $item->imageFileName; ?>">
                            </div>
                            <hr class="m-1">
                            <div class="card-body">
...
<script>
    ...
    function reviseAuctionStatus(){
        $.ajax({
                url: "<?php echo URLROOT; ?>/auctions/reviseAuctionStatus",
                type: "POST",
                data: {},
                cache: false,
                success: function(result){
                    console.log('Auction Status Revised');
                }
            });
    }
</script>