<?php require APPROOT . "/views/inc/header.php"; ?>
    ...
    <main role="main">
        <?php echo empty($data['items']) ? '<div>No Items Posted Yet!</div>' : '' ?>
                    ...
                    <div class="col-md-4" id="<?php echo $item->auctionID ?>Card">
                        <div class="card mb-4 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <p class="amountSlot text-info" id="<?php echo $item->auctionID ?>Amount"><?php echo $item->isActive == 1 ? "Highest Bid: $" : "Sold At: $"; ?><?php echo $item->amount; ?></p>
