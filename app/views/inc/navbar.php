    ...
    <div class="collapse navbar-collapse" id="navbarsExampleDefault">
        <ul class="navbar-nav mr-auto">
            ...
            <?php if(isset($_SESSION['user_id'])) : ?>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo URLROOT; ?>/auctions/reviseAuctionStatus">Revise Auction Status</a>
                </li>
        ...
        <ul class="navbar-nav ml-auto">
            <?php if(isset($_SESSION['user_id'])) : ?>
                ...
                <!-- <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdown01">
                         <a class="dropdown-item text-primary" href="<?php echo URLROOT; ?>/users/logout">Logout</a>
                    </ul>
                    <ul class="dropdown-menu" aria-labelledby="dropdown01">
                         <a class="dropdown-item text-primary" href="<?php echo URLROOT; ?>/users/deregistration">Delete My Account</a>
                    </ul>
                </li> -->
                <li class="nav-item">
